...
4. Deploying to an environment that already has instances running: Pull the current environment from Git and build on top of it. Or build the new environment in a different region if the two environments are to be kept separate.
...
- Database should be attached to web server instances. What is best practice here? And how do DBs in different AZs share data?
- Auto-scaling.
